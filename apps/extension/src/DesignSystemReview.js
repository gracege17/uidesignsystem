...
function TypographySection({ tokens, summary, theme }) {
    ...
    return (_jsxs("div", { className: "space-y-8", children: [_jsxs("div", { className: "space-y-0", children: [summary.fontFamilies.map((family, index) => (_jsxs("div", { className: `${ui.heroPanel} ${index > 0 ? "mt-4" : ""}`, children: [_jsx("p", { className: `text-[11px] uppercase tracking-[0.22em] ${ui.heroMetaText}`, children: family }), _jsxs("div", { className: `mt-6 space-y-3 ${ui.heroBodyText}`, style: { fontFamily: `"${family}", sans-serif` }, children: [_jsx("p", { className: "text-2xl tracking-wide", children: "ABCDEFGHIJKLMNOPQRSTUVWXYZ" }), _jsx("p", { className: "text-2xl tracking-wide", children: "abcdefghijklmnopqrstuvwxyz" }), _jsx("p", { className: "text-2xl tracking-wide", children: "0123456789" }), _jsx("p", { className: "text-2xl tracking-wide", children: "!@#$%^&*()" })] })] }, family))), summary.fontFamilies.length === 0 && (_jsxs("div", { className: `${ui.heroPanel}`, children: [_jsx("p", { className: `text-[11px] uppercase tracking-[0.22em] ${ui.heroMetaText}`, children: "Typeface" }), _jsx("h2", { className: `mt-3 text-5xl font-semibold tracking-tight ${ui.heroHeadingText}`, children: "Typography" })] }))] }), _jsx("div", { className: "space-y-8", children: scale.map(({ role, token }) => (_jsxs("div", { className: `border-t pt-6 ${ui.rule}`, children: [_jsxs("div", { className: `mb-4 grid grid-cols-[minmax(0,1fr)_100px_100px] gap-4 text-[11px] uppercase tracking-[0.18em] ${ui.mutedText}`, children: [_jsxs("span", { children: [role, " \u2014 ", token.fontFamily] }), _jsx("span", { children: "Font Size" }), _jsx("span", { children: "Line Height" })] }), _jsxs("div", { className: "grid grid-cols-[minmax(0,1fr)_100px_100px] gap-4", children: [_jsx("p", { className: `pr-6 ${ui.headingText}`, style: {
