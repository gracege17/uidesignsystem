...
function ComponentPreview({ component, tokens, theme, showSpecs = true }) {
    ...
    if (component.type === "Navigation") {
        ...
        if (component.cornerRadius !== undefined)
            specs.push({ label: "Corner", value: `${component.cornerRadius}px` });
        return (_jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "flex items-center gap-4 border px-5 py-3 text-sm", style: {
                        ...
                        fontSize: type ? `${Math.min(type.fontSize, 18)}px` : undefined,
                        fontWeight: type?.fontWeight,
                    }, children: [_jsx("span", { children: "Overview" }), _jsx("span", { style: { opacity: 0.6 }, children: "Pricing" }), _jsx("span", { style: { opacity: 0.6 }, children: "Docs" })] }), showSpecs && specs.length > 0 && (_jsx("div", { className: "space-y-1.5", children: specs.map((spec) => (_jsxs("div", { className: "grid grid-cols-[64px_1fr] gap-3 text-xs", children: [_jsx("span", { className: `font-medium ${ui.mutedText}`, children: spec.label }), _jsx("span", { className: ui.bodyText, children: spec.value })] }, spec.label))) }))] }));
    }
    if (component.type === "Accordion") {
        ...
        if (type)
            specs.push({ label: "Font", value: `${type.fontFamily} · ${type.fontSize}px · ${type.fontWeight}` });
        return (_jsxs("div", { className: "space-y-4", children: [_jsxs("div", { style: { fontFamily: type ? `"${type.fontFamily}", sans-serif` : undefined }, children: [_jsxs("div", { className: "flex items-center justify-between py-4 text-sm", style: { borderBottom: `1px solid ${dividerColor}`, color: headingText, fontWeight: type?.fontWeight ?? 600 }, children: [_jsx("span", { children: "Payroll takes just a few clicks" }), _jsx("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", style: { opacity: 0.5 }, children: _jsx("path", { d: "M4 6l4 4 4-4", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }) })] }), _jsxs("div", { style: { borderBottom: `1px solid ${dividerColor}` }, children: [_jsxs("div", { className: "flex items-center justify-between py-4 text-sm", style: { color: headingText, fontWeight: type?.fontWeight ?? 600 }, children: [_jsx("span", { children: "Sync hours with payroll" }), _jsx("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", children: _jsx("path", { d: "M4 10l4-4 4 4", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }) })] }), _jsx("p", { className: "pb-4 text-xs leading-relaxed", style: { color: bodyTextColor }, children: "Automatically calculates and syncs hours, PTO, and holidays with payroll." })] }), _jsxs("div", { className: "flex items-center justify-between py-4 text-sm", style: { borderBottom: `1px solid ${dividerColor}`, color: headingText, fontWeight: type?.fontWeight ?? 600 }, children: [_jsx("span", { children: "Pay yourself compliantly" }), _jsx("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", style: { opacity: 0.5 }, children: _jsx("path", { d: "M4 6l4 4 4-4", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }) })] })] }), showSpecs && specs.length > 0 && (_jsx("div", { className: "space-y-1.5", children: specs.map((spec) => (_jsxs("div", { className: "grid grid-cols-[64px_1fr] gap-3 text-xs", children: [_jsx("span", { className: `font-medium ${ui.mutedText}`, children: spec.label }), _jsx("span", { className: ui.bodyText, children: spec.value })] }, spec.label))) }))] }));
    }
